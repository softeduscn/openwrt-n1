...
s:tab("gfw", translate(name))

o = s:taboption("gfw", TextValue, "", "", "<font color='red'>" .. translate("Please input the domain names, every line can input only one domain. ") .. "</font>" .. "</font>")
o.rows = 15
o.wrap = "off"
