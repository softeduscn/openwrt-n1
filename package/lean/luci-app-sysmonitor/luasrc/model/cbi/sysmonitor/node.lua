...
s.description = '<table><style>.button1 {-webkit-transition-duration: 0.4s;transition-duration: 0.4s;padding: 1px 3px;text-align: center;background-color: white;color: black;border: 2px solid #4CAF50;border-radius:5px;}.button1:hover {background-color: #4CAF50;color: white;}.button1 {font-size: 11px;}</style><tr><td><button class="button1" title="Set switch VPN mode"><a href="/cgi-bin/luci/admin/sys/sysmonitor/sysmenu?sys=VPNswitch&sys1=&redir=node">'..translate(check)..'</a></button>'..box..' <button class="button1" title="Set URL check VPN mode"><a href="/cgi-bin/luci/admin/sys/sysmonitor/sysmenu?sys=URLchkVPN&sys1=&redir=node">'..translate(checkvpn)..'</a></button>'..vpn
s.anonymous = true
